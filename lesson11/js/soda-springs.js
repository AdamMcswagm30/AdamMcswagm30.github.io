// Weather API
function weatherApi() {
    const prestonURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=9d9f72be67a23278732a4344d3daa9f8';
    const forcastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=9d9f72be67a23278732a4344d3daa9f8';
    fetch(prestonURL)
